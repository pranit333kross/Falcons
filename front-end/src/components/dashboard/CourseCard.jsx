...
const CourseCard = ({ course, onSelect, index }) => {
    ...
    return (
        <div
            ...
            className={`bg-white rounded-xl shadow-lg overflow-hidden transform hover:-translate-y-2 hover:shadow-2xl transition-all duration-500 cursor-pointer group ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'
                }`}
        >
            ...
            {/* <div className="p-6 bg-green-300 flex items-center justify-center h-32">
                <BookOpen className="h-16 w-16 text-white group-hover:scale-110 transition-transform" />
            </div> */}
